...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Unlimited keywords",
      "Relevancy & opportunity scoring (up to 50 keywords)",
  ...
  },
  {
    ...
    description: "Metadata timeline & benchmarking, AI keyword suggestions, review tracking, and relevancy & opportunity scoring (up to 500 keywords) across unlimited apps.",
    badge: null,
    features: [
  ...
  },
  {
    ...
    description: "Everything in Pro, plus long tail keyword tools, ranked keywords, group by intent, keyword simulator, and a bigger relevancy & opportunity scoring pool across unlimited apps.",
    badge: null,
    features: [
