...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    description: "Keyword tracking with relevancy scoring for a handful of growing apps.",
  ...
  },
  {
    ...
    description: "Metadata history, category benchmarking, and review tracking for teams growing multiple apps.",
    badge: "Free for 7 days",
    trialDays: 7,
    features: [
      "1 workspace",
