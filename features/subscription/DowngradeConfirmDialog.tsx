        ...
        {step === "ask" ? (
          <>
            <div className="flex items-start gap-3 mb-5">
              ...
              <div>
                <h2 className="text-base font-semibold text-white light:text-gray-900">Move to the Free plan?</h2>
          ...
          <>
            <div className="flex items-start gap-3 mb-5">
              ...
              <div>
                <h2 className="text-base font-semibold text-white light:text-gray-900">Before you go…</h2>
                <p className="mt-1 text-sm text-gray-400 light:text-gray-600">Help us understand why, so we can improve.</p>
              </div>
            </div>

            <div className="space-y-4">
              <fieldset>
                <legend className="text-sm font-medium text-gray-300 light:text-gray-700 mb-2">Why are you leaving?</legend>
                <div className="space-y-1.5">
                  {REASONS.map((r) => (
                    <label key={r} className="flex items-center gap-2.5 text-sm text-gray-300 light:text-gray-700 cursor-pointer">
                      <input
                        type="radio"
                        name="cancel-reason"
                        value={r}
                        ...
                        disabled={confirming}
                        className="size-3.5 border-white/20 bg-white/5 light:bg-black/[0.04] text-indigo-500 focus:ring-indigo-500 focus:ring-offset-0"
                      />
                      {r}
                    </label>
                  ))}
              ...
              <div>
                <label htmlFor="cancel-recommendation" className="text-sm font-medium text-gray-300 light:text-gray-700">
                ...
                <textarea
                  ...
                  className="mt-2 w-full resize-none rounded-lg bg-white/[0.06] light:bg-black/[0.05] px-3 py-2 text-sm text-white light:text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-60"
                />
              </div>
            </div>
