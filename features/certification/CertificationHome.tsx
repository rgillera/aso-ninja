      ...
      <div className="mx-auto max-w-4xl px-6 py-10">
        <div className="flex items-center gap-3">
          <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-indigo-500/15">
            <TrophyIcon className="size-6 text-indigo-400 light:text-indigo-600" />
          </div>
          <div>
            <h1 className="text-xl font-semibold text-white light:text-gray-900">ASO Certification</h1>
            <p className="text-sm text-gray-400 light:text-gray-600">Learn app store optimization from the ground up, then prove it on the exam.</p>
          </div>
        </div>
        ...
        {certification && (
          <div className="mt-6 rounded-2xl bg-emerald-500/10 ring-1 ring-emerald-500/25 p-5">
            <div className="flex items-center gap-2">
              <CheckBadgeIcon className="size-5 shrink-0 text-emerald-400 light:text-emerald-700" />
            ...
            <p className="mt-1.5 text-xs text-gray-400 light:text-gray-600">Lost your PDF? Redownload it here anytime.</p>
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <p className="mt-4 text-sm font-semibold text-white light:text-gray-900">Learn ASO, Basic to Advanced</p>
          ...
          >
            ...
            <p className="mt-4 text-sm font-semibold text-white light:text-gray-900">Take the Exam</p>
            <p className="mt-1.5 text-xs leading-relaxed text-gray-400 light:text-gray-600">
        ...
        <div className="mt-10">
          <p className="text-xs font-semibold uppercase tracking-widest text-gray-600 light:text-gray-400">What&apos;s covered</p>
          <div className="mt-3 grid gap-5 sm:grid-cols-3">
            {CERTIFICATION_LEVEL_ORDER.map((level) => (
              <div key={level}>
                <p className="text-sm font-semibold text-white light:text-gray-900">{LEVEL_LABEL[level]}</p>
                <ul className="mt-1.5 space-y-1">
                  {modulesByLevel(level).map((m) => (
                    <li key={m.id} className="text-sm text-gray-400 light:text-gray-600">{m.title}</li>
                  ))}
                </ul>
              </div>
            ))}
