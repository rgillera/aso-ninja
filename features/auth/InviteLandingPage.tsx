...
export default function InviteLandingPage() {
  ...
  if (!showCodeEntry) {
    return (
      <div className="min-h-screen bg-[#f5f6f8] flex flex-col items-center justify-center px-4 gap-3">
        <p className="text-sm text-gray-600">{error ?? "Confirming your invite…"}</p>
        <button
          type="button"
    ...
    <div className="min-h-screen bg-[#f5f6f8] flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="mt-6 text-2xl font-semibold text-gray-900">Enter your invite code</h1>
