...
export default function MetadataBenchmark({ app, storeData, benchmark, daysSinceUpdate }: Props) {
  ...
  if (!isPlanAtLeast(planSlug, "basic")) {
    return (
      <main className="flex flex-col h-full overflow-hidden bg-[#111318]">
        ...
        <FeatureLocked
          minPlan="basic"
          icon={ChartBarIcon}
          title="Benchmark is a Basic feature"
          description="Upgrade to Basic or above to see how your metadata compares to your category."
          benefits={[
