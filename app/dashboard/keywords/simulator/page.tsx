...
export default async function Page({ searchParams }: PageProps) {
  ...
  if (lastAppId && allApps.find(a => a.id === lastAppId)) redirect(`/dashboard/apps/${lastAppId}/simulate`);
  if (allApps.length > 0) redirect(`/dashboard/apps/${allApps[0].id}/simulate`);
