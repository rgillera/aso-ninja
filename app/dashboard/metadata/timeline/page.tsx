...
export default async function Page() {
  ...
  if (lastAppId && allApps.find(a => a.id === lastAppId)) redirect(`/dashboard/apps/${lastAppId}/timeline`);
  if (allApps.length > 0) redirect(`/dashboard/apps/${allApps[0].id}/timeline`);
