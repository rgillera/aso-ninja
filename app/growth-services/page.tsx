      ...
      <main>
        <section className="pt-32 pb-16 sm:pb-24">
          ...
          <div className="mx-auto max-w-3xl px-6 text-center lg:px-8">
            <p className="text-sm font-semibold text-indigo-600 uppercase tracking-widest">Growth Services</p>
            <h1 className="mt-4 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
              Skip the hire. <span className="text-indigo-600">Get a full growth team in the Philippines</span>
            </h1>
        ...
        <section className="pb-24 sm:pb-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-sm font-semibold text-indigo-600 uppercase tracking-widest">Why it works</p>
            ...
            <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:grid-cols-3 lg:max-w-none">
              {benefits.map((b) => (
                <div
                  key={b.name}
                  className="flex flex-col items-center rounded-2xl bg-white p-8 text-center shadow-clay ring-1 ring-black/5"
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-50 ring-1 ring-indigo-100">
                    <b.icon className="size-5 text-indigo-600" aria-hidden="true" />
                  </div>
                  <h3 className="mt-6 text-lg font-semibold text-gray-900">{b.name}</h3>
        ...
        <section className="pb-24 sm:pb-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-sm font-semibold text-indigo-600 uppercase tracking-widest">What&apos;s included</p>
              <h2 className="mt-4 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            ...
            <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:grid-cols-2 lg:max-w-none lg:grid-cols-3">
              {services.map((s) => (
                ...
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-50 ring-1 ring-indigo-100">
                    <s.icon className="size-5 text-indigo-600" aria-hidden="true" />
                  </div>
                  <h3 className="mt-6 text-lg font-semibold text-gray-900">{s.name}</h3>
                  <p className="mt-3 text-sm leading-6 text-gray-600 flex-1">{s.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="pb-24 sm:pb-32">
          <div className="mx-auto max-w-5xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <p className="text-sm font-semibold text-indigo-600 uppercase tracking-widest">The math</p>
              <h2 className="mt-4 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            ...
            <div className="mx-auto mt-16 grid max-w-5xl grid-cols-1 gap-6 sm:grid-cols-2 items-stretch" style={{ paddingTop: "1rem" }}>
              <div className="flex flex-col rounded-2xl bg-white p-8 shadow-clay ring-1 ring-black/5">
                <h3 className="text-lg font-semibold text-gray-900">In-house hire (US market)</h3>
                <p className="mt-2 text-xs text-gray-500">One person, one salary</p>
                <div className="mt-4 flex items-baseline gap-x-2">
                  <span className="text-3xl font-bold tracking-tight text-gray-900">$90k&ndash;$140k+</span>
              ...
              <div className="relative flex flex-col rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-600 ring-1 ring-indigo-400/40 shadow-clay-lg p-8">
                ...
                <p className="mt-2 text-xs text-indigo-200">A full team, outsourced to the Philippines</p>
                <div className="mt-4 flex items-baseline gap-x-2">
                  <span className="text-3xl font-bold tracking-tight text-white">A fraction</span>
                  <span className="text-xs text-indigo-200">of one US hire</span>
                </div>
                <ul className="mt-8 flex-1 space-y-3">
                ...
                <a
                  ...
                  className="mt-8 inline-flex items-center justify-center rounded-md bg-white px-6 py-3 text-sm font-semibold text-indigo-600 shadow-clay-sm hover:bg-indigo-50 transition-colors"
                >
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 sm:grid-cols-2 lg:max-w-none lg:grid-cols-4">
              {engagementSteps.map((step) => (
                <div key={step.n} className="flex flex-col rounded-2xl bg-white p-8 shadow-clay ring-1 ring-black/5">
                  <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-50 ring-1 ring-indigo-100">
        ...
        <section className="pb-24 sm:pb-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-3xl rounded-2xl bg-white px-6 py-10 text-center shadow-clay ring-1 ring-black/5 sm:px-10">
              <h2 className="text-2xl font-bold text-gray-900">Ready to talk growth?</h2>
